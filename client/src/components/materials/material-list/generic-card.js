            ...
            <Col md={11}>
                <Card className='generic-card'>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text> Breve Descripción: {description}</Card.Text>
                        <Card.Text> Género: {genre}</Card.Text>
                        <Card.Text> Autor: {author}</Card.Text>
                        <Link to={`/materials/${genre}/${_id}`} className='btn btn-outline-warning navbar-color-second btn-block btn-sm'>Ver Detalles</Link>
